...
// $email->addTo(['lobojeanz@gmail.com','jeanlobo94@gmail.com','jeanlobo.makita.in'], "Example User");
...
Route::get('/send-email', function () {
    try {
        ...
        foreach ($recipients as $recipient) {
            $email->addTo($recipient, "Example User");
        }
...
Route::group(['prefix' => 'admin','middleware' => ['admin']], function() {
    ...
    Route::get('/travelmanagement/applyviewclaimtravelexpenses',[TravelManagementController::class,'getAllBTAppliedByLoggedInEmployee'])->name('travelmanagement.applyviewclaimtravelexpenses');
    ...
    Route::get('/travelmanagement/bt-applications-requests-manager',[TravelManagementController::class,'getAllBTRequestsForMangersTeam'])->name('travelmanagement.bt-applications-requests-manager');
    Route::post('/travelmanagement/change-bta-applications-status-manager-approval',[TravelManagementController::class,'changeBTAStatusToManagerApprovReject'])->name('travelmanagement.change-bta-applications-status-manager-approval');
    Route::get('/travelmanagement/bt-applications-paymentadvancerequests-accountdept',[TravelManagementController::class,'getAllBTAdvanceRequestsForAccountDept'])->name('travelmanagement.bt-applications-paymentadvancerequests-accountdept');
    Route::get('/travelmanagement/bta-application-details/{btaSlug?}',[TravelManagementController::class,'getSpecificBTADetails'])->name('travelmanagement.bta-application-details');
    Route::get('/travelmanagement/bta-application-details-manger/{btaSlug?}',[TravelManagementController::class,'getSpecificBTADetailsManager'])->name('travelmanagement.bta-application-details-manger');
    Route::get('/travelmanagement/bta-application-details-account-dep/{btaSlug?}',[TravelManagementController::class,'getSpecificBTADetailsForAccountDepertment'])->name('travelmanagement.bta-application-details-account-dep');
    Route::post('/travelmanagement/bt-account-operation-chanel',[TravelManagementController::class,'insertBtAccountLedger'])->name('travelmanagement.bt-account-operation-chanel');
    Route::post('/travelmanagement/bta-application-record-statusupdate',[TravelManagementController::class,'btaApplicationRecordStatusUpdate'])->name('travelmanagement.bta-application-record-statusupdate');
    Route::get('/travelmanagement/bt-applications-requests-hr',[TravelManagementController::class,'getAllBTRequestsForHRTeam'])->name('travelmanagement.bt-applications-requests-hr');
    Route::get('/travelmanagement/bta-application-details-hr-process/{btaSlug?}',[TravelManagementController::class,'getSpecificBTADetailsForHRProcess'])->name('travelmanagement.bta-application-details-hr-process');
    Route::post('/travelmanagement/bta-application-claim-by-applicant',[TravelManagementController::class,'btaApplicationClaimByApplicant'])->name('travelmanagement.bta-application-claim-by-applicant');
    ...
    Route::post('/upload-promotion',[PromotionController::class,'uploadPromotion'])->name('upload-promotion');
