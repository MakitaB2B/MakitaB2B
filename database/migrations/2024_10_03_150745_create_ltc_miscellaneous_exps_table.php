...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('ltc_miscellaneous_exps', function (Blueprint $table) {
            ...
            $table->unsignedDecimal('courier_bill', 21, 4)->change();
            $table->unsignedDecimal('xerox_stationary', 21, 4)->change();
            $table->unsignedDecimal('office_expense', 21, 4)->change();
            $table->unsignedDecimal('monthly_mobile_bills', 21, 4)->change();
