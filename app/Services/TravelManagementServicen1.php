...
class TravelManagementService{
    ...
    public function getLTCApplicationDetails($ltcappslug){
        ...
        $result = LtcClaimApplication::with([
            ...
            'ltcTravelClaims:ltc_claim_applications_slug,mode_of_transport,type_of_transport,place_visited,opening_meter,closing_meter,total_km,toll_charge,claim_amount,ltc_claim_id',
            //'ltcTravelClaims.travelFiles:type,file_path,file_type,ltc_claim_id',
            'ltcFoodClaims:ltc_claim_applications_slug,in_time,out_time,food_exp,ltc_date,ltc_claim_id',
            'travelFiles',
            'miscFiles'
        ])
        ->where('ltc_claim_applications_slug', $ltcappslug)
