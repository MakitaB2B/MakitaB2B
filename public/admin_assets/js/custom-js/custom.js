            ...
            data.forEach((row, index) => {
                let mainRow = `
                    <tr>
                        ...
                        <td>01-JAN-2025 10:00 AM</td>
                        <td class="td-hide">03-JAN-2025 12:00 PM</td>
                        <td class="td-hide">New Delhi</td>
                        <td class="td-hide">3</td>
                    ...
                    <tr>
                        <td colspan="10" class="p-0">
                            <div id="collapse${index}" class="accordion-collapse collapse">
                                <div class="accordion-body">
                                    <div class="exp-card-wrapper">
                                        <div class="exp-data-wrapper dd-data">
                                            <div class="exp-card-title">Expense Details</div>
                                            <div>
                                                <div class="exp-data">
                                                    <span class="exp-title">Start Date</span>
                                                    <span class="exp-value">${row.sartDataTime}</span>
                                                </div>
                                                <div class="exp-data">
                                                    <span class="exp-title">End Date</span>
                                                    <span class="exp-value">${row.endDataTime}</span>
                                                </div>
                                                <div class="exp-data">
                                                    <span class="exp-title">No. Of Days</span>
                                                    <span class="exp-value">${row.noOfDays}</span>
                                                </div>
                                            </div>
                                            <div>
                                                <div class="exp-data">
                                                    <span class="exp-title">Places Vistied</span>
                                                    <span class="exp-value">${row.placesVisited}</span>
                                                </div>    
                                                <div class="exp-data">
                                                    <span class="exp-title">Pre Approved</span>
                                                    <span class="exp-value">${row.preApproved==1?'YES':'NO'}</span>
                                                </div> 
                                                <div class="exp-data">
                                                    <span class="exp-title">Purpose</span>
                                                    <span class="exp-value">${row.purpose}</span>
                                                </div>
                                            </div>           
                                        </div>
                                        ...
                                        ${row.details.map((details, index) =>`
                                            <div class="exp-data-wrapper main-wrap">
                                                <div class="exp-card-title">Day ${index + 1}</div>
                                                <div class="exp-data-wrapper food-exp-data">
                                                    <div class="exp-card-title">Food Expense</div>
                                                    <div class="exp-data">
                                                        <span class="exp-title">Breakfast</span>
                                                        <span class="exp-value">&#8377;${details.foodExpense[0].breakfast.amount || 0}</span>
                                                        <span class="exp-bill-copy"><a href="${baseURL}${details.foodExpense[0].breakfast.files[0].name}"><i class="fa-solid fa-file"></i></a></span>
                                                    </div>
                                                    <div class="exp-data">
                                                        <span class="exp-title">Lunch</span>
                                                        <span class="exp-value">&#8377;${details.foodExpense[0].lunch.amount || 0}</span>
                                                        <span class="exp-bill-copy"><a href="${baseURL}${details.foodExpense[0].lunch.files[0].name}"><i class="fa-solid fa-file"></i></a></span>
                                                    </div>
                                                    <div class="exp-data">
                                                        <span class="exp-title">Dinner</span>
                                                        <span class="exp-value">&#8377;${details.foodExpense[0].dinner.amount || 0}</span>
                                                        <span class="exp-bill-copy"><a href="${baseURL}${details.foodExpense[0].dinner.files[0].name}"><i class="fa-solid fa-file"></i></a></span>
                                                    </div>                
                                                </div>
                                                <div class="exp-data-wrapper misc-exp-data">
                                                    <div class="exp-card-title">Miscellaneous Expense</div>
                                                    ${details.miscExpense.map(misc => `
                                                    <div class="exp-data">
                                                        <span class="exp-title">${misc.type}</span>
                                                        <span class="exp-value">&#8377;${misc.amount}</span>
                                                        <span class="exp-bill-copy">
                                                ...
                                                <div class="exp-data-wrapper travel-exp-data">
                                                    ...
                                                    <div class="exp-data exp-table">
                                                        ...
                                                        <div class="row-body">
                                                            ${details.travelEntries.map(travelEntry => `
                                                                <div class="exp-row">
                                                                    <span class="exp-value"><span class="exp-title">Transport Mode</span>${travelEntry.typeOfTransport} - ${travelEntry.modeOfTransport}</span>
                                                                    <span class="exp-value"><span class="exp-title">Starting Meter</span>${travelEntry.startingMeter}</span>
                                                                    <span class="exp-value"><span class="exp-title">Closing Meter</span>${travelEntry.closingMeter}</span>
