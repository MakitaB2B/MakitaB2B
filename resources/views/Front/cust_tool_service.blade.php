        ...
        <main class="main-content bg-grey">
            <div class="container">
                    <header class="dashboard-header">
                        <h1 class="dashboard-title">Tool Service Dashboard</h1>
                            ...
                            <table>
                                <thead>
                                    <tr>
                                        ...
                                        <th class="mobile-hide">SR Date</th>
                                        <th class="mobile-hide">Service Center</th>
                                        <th class="mobile-hide">Issue</th>
                                        <th>Status</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr class="table-row">
                                        ...
                                        <td class="mobile-hide">Battery Issue</td>
                                        <td><span class="status-badge status-diagnosing">Diagnosing</span></td>
                                    </tr>
                                    <tr class="table-row">
                                        <td>#532027529</td>
                                        <td>DF001G</td>
                                        ...
                                        <td class="mobile-hide">HQ Service Center</td>
                                        <td class="mobile-hide">Battery Issue</td>
                                        <td><span class="status-badge status-warranty">Under Warranty</span></td>
                                    </tr>
