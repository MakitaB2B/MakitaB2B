...
@section('page_title', 'Locations List | MAKITA')
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-2">
                        <a href="{{ url('admin/location/manage-location') }}"><button type="button"
                                class="btn btn-block btn-primary">Add Location</button></a>
                    </div>
                    <div class="col-sm-10">
                                    ...
                                    <tbody>
                                        @foreach ($locationList as $key => $list)
                                            <tr>
                                                ...
                                                <td><a href="{{ url('admin/location/manage-location/') }}/{{ Crypt::encrypt($list->location_slug) }}"
