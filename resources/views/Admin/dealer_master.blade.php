...
@section('dealer-expandable', 'menu-open')
@section('dealer-select', 'active')
    ...
    <div class="content-wrapper rescss">
        ...
        <section class="content-header">
            <div class="container-fluid">
                ...
                @endif
                @permission('1771444511689280780')
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Dealer Master</h1>
                    </div>
                    <div class="col-sm-6">
                        ...
                        <form action="{{ route('upload-dealer') }}" method="post" enctype="multipart/form-data"
                            ...
                            <label for="inputField" class="btn btn-info float-right">Dealer Master File</label>
