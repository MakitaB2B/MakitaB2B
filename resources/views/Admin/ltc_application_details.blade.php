                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <input type="hidden" value="{{$result['status']}}" id="overallstatusval">
                                    </div>
                                    @if($page=='account')
                                    <div class="form-group col-md-1">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-2">
                                        ...
                                        <select class="ltcappstatus form-control" style="border-color: orange;" data-id="{{ $Data['ltc_claim_slug'].'-'.'ltc' }}" >
                                               <option value="0"   {{$Data["status"] == 0 ? "selected" : ""}} {{ $page == 'manager' ||  $page == 'hr' || $page == 'account'? 'disabled' : '' }} style="{{ $page == 'manager' || $page == 'hr' || $page == 'account' ? 'color: grey;' : 'color: orange;' }}">In-Review</option>
                                               <option value="1"   {{$Data["status"] == 1 ? "selected" : ""}} {{ $page == 'account' ||  $page == 'hr' ? 'disabled' : '' }} style="{{ $page == 'account' ||  $page == 'hr' ? 'color: grey;' : 'color: orange;' }}">Approved By Manager, In Review By HR</option>
                                               <option value="2"   {{$Data["status"] == 2 ? "selected" : ""}} {{ $page == 'account' ||  $page == 'hr' ? 'disabled' : '' }} style="{{ $page == 'account' ||  $page == 'hr' ? 'color: grey;' : 'color: orange;' }}">Rejected By Manager</option>
                                               <option value="3"   {{$Data["status"] == 3 ? "selected" : ""}} disabled>Amount Paid</option>
                                               <option value="4"   {{$Data["status"] == 4 ? "selected" : ""}} {{ $page == 'manager' ||  $page == 'account'? 'disabled' : '' }} style="{{ $page == 'manager' ||  $page == 'account' ? 'color: grey;' : 'color: orange;' }}">Approved By HR, In Review By Accounts</option>
                                               <option value="5"   {{$Data["status"] == 5 ? "selected" : ""}} {{ $page == 'manager' ||  $page == 'account'? 'disabled' : '' }} style="{{ $page == 'manager' ||  $page == 'account' ? 'color: grey;' : 'color: orange;' }}">Rejected By HR</option>
                                               ...
                                               <option value="8"   {{$Data["status"] == 8 ? "selected" : ""}} {{ $page == 'manager' ||  $page == 'hr'? 'disabled' : '' }} style="{{ $page == 'manager' ||  $page == 'hr' ? 'color: grey;' : 'color: orange;' }}">Rejected By Accounts</option>
                                        </select>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-2">
                                        ...
                                        <select class="ltcappstatus form-control" data-id="{{ $result['ltcMiscellaneousExp']['ltc_miscellaneous_slug'].'-'.'ltcmis' }}" style="border-color: orange;">
                                            ...
                                            <option value="4" {{ $result['ltcMiscellaneousExp']['status'] == 4 ? "selected" : ""}} {{ $page == 'manager' ||  $page == 'account'? 'disabled' : '' }} style="{{ $page == 'manager' ||  $page == 'account' ? 'color: grey;' : 'color: orange;' }}">Approved By HR, In Review By Accounts</option>
                                            <option value="5" {{ $result['ltcMiscellaneousExp']['status'] == 5 ? "selected" : ""}} {{ $page == 'manager' ||  $page == 'account'? 'disabled' : '' }} style="{{ $page == 'manager' ||  $page == 'account' ? 'color: grey;' : 'color: orange;' }}">Rejected By HR</option>
                                            ...
                                            <option value="8" {{ $result['ltcMiscellaneousExp']['status'] == 8 ? "selected" : ""}} {{ $page == 'manager' ||  $page == 'hr'? 'disabled' : '' }}  style="{{ $page == 'manager' ||  $page == 'hr' ? 'color: grey;' : 'color: orange;' }}">Rejected By Accounts</option>
                                        </select>
    ...
    @push('scripts')
        ...
        function toggleSelectBox() {
            ...
            if (currentPage === 'manager' && !['0', '1', '2'].includes(selectedValue)) {
                ...
                $(".ltcappstatus").prop('disabled', true);
            }else if(currentPage === 'account' && !['4', '6', '7','8'].includes(selectedValue)){
                $(".ltcappstatus").prop('disabled', true);
            }
        }
         ...
         $('.ltcappstatus').on('change', function() {
           ...
           $('#makepayment').on('click', function(e) {
                ...
                let ltcappslug = $('#ltcSlug').val();
                    $.ajax({
                        url: '/admin/travelmanagement/ltc-application-details/payment-status',
                        type: 'post',
                        data: {
                            status: 3,
                            ltcappslug:ltcappslug,
