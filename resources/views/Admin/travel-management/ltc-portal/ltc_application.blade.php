                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" id="breakfastClaim" class="form-control expense-input">
                                        </div>
                                    </div>
                ...
                <div class="card-body">
                    ...
                    <div class="row mb-3 approval-documents-section" style="display: none;">
                        <div class="col-12">
                            ...
                            <div class="approval-documents-uploader"></div>
...
@push('scripts')
    ...
    <script src="{{ asset('admin_assets/js/custom-js/ltc-storage.js') }}"></script>
    ...
    <script>
        ...
        $("#submit-form").click(function () {
            $.ajax({
                url: "/admin/travelmanagement/create-travel-management-applications", 
                method: "POST",
                data:expenseData;
