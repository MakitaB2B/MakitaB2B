    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-2">
                        <a href="{{ url('admin/state/manage-state') }}"><button type="button"
                                class="btn btn-block btn-primary">Add State</button></a>
                    </div>
                    <div class="col-sm-10">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        @foreach ($stateRecords as $key => $list)
                                            <tr>
                                                <td>{{ $key + 1 }}</td>
                                                <td>{{ $list->name }}</td>
                                                <td>{{ $list->status === 1 ? "Active" : "De-Active" }}</td>
                                                <td><a href="{{ url('admin/state/manage-state/') }}/{{ Crypt::encrypt($list->state_slug) }}"
