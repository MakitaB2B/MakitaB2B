...
@section('page_title', 'Department List | MAKITA')
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-2">
                        <a href="{{ url('admin/department/manage-department') }}"><button type="button"
                                class="btn btn-block btn-primary">Add Department</button></a>
                    </div>
                    <div class="col-sm-10">
                                    ...
                                    <tbody>
                                        @foreach ($departmentList as $key => $list)
                                            <tr>
                                                ...
                                                <td><a href="{{ url('admin/department/manage-department/') }}/{{ Crypt::encrypt($list->department_slug) }}"
