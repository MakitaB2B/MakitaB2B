                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{ url('admin/roles') }}">Role List</a>
                            </li>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">Operate Role Data</h3>
                            </div>
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form method="POST" action="{{ route('roles.manage-role-process') }}"
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" class="form-control" name="name"
                                                value="{{ $name }}" required id="exampleInputRoleName"
                                ...
                                <input type="hidden" value="{{ $role_slug }}" name="role_slug" required />
                            </form>
                        </div>
                        <!-- /.card -->
